...
public class Main {
    ...
    private static final String[] NAME_SURNAME_PLAYERS={
    ...
    private static final String[] ROLE_PLAYER={"Goalkeeper", "Defender","Midfielder","Striker"};


    public static void main(String[] args) {

        Trainer trainer=new Trainer("Franco Bianchi", 45,"Defensive");
